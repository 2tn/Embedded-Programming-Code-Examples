 ...
 */
int inv_get_sensor_type_accel(long *data, int8_t *accuracy,
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_gyro(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_compass(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_quat(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
 ...
 *  @return     1 if data was updated. 
 */
int inv_get_sensor_type_heading(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
 ...
 *  @return     1 if data was updated.
 */
int inv_get_sensor_type_euler(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
	long t1, t2, t3;
 ...
 *  @return     1 if data was updated.
 */
int inv_get_sensor_type_rot_mat(long *data, int8_t *accuracy,
		inv_time_t *timestamp) {
...
static inv_error_t inv_generate_eMPL_outputs(
	...
	int use_sensor;
	long sr = 1000;
	inv_get_quaternion_set(eMPL_out.quat, &eMPL_out.quat_accuracy,
	...
	if ((sensor_cal->accel.status & INV_SENSOR_ON)
			&& (sr > sensor_cal->accel.sample_rate_ms)) {
		sr = sensor_cal->accel.sample_rate_ms;
		use_sensor = 1;
	}
	if ((sensor_cal->compass.status & INV_SENSOR_ON)
